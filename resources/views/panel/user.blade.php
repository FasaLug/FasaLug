...
<head>
    ...
    <title>لاگ فسا / پنل کاربری</title>
    <!-- Fonts -->
...
<body id="app">
    <div class="mx-3">
        <div
        class="nav mx-auto mt-3 shadow-sm px-4 bg-white rounded w-full min-h-[65px] max-w-[1440px] flex items-center justify-between">
    ...
    <div class="pinglug shadow-lg relative select-none right-0 top-48 rounded-l-xl bg-white w-[800px] min-h-[30rem]">
        <div class="pt-16 px-7 w-full">
            <div class="font-semibold">
                <div class="text-5xl">گروه کاربران لینوکس فسا</div>
                <div class="w-[600px] pt-10">
                    <div class="text-2xl">لاگ یا گروه کاربران لینوکس فسا گروهی مستقل و مردم نهاد است که در زمینه گنو / لینوکس و نرم افزار های آزاد فعالیت میکند</div>
                </div>
